...
# Key_entry
label_name=Label(body,text="Key : (type any number)",fg="Brown",font=('helvetica',20,'bold'))
...
# Mode_entry
label_name=Label(body,text="Mode :(type e/d : e- encrypt,d-decrypt)",fg="Brown",font=('helvetica',20,'bold'))
